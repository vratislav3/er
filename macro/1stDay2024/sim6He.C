...
// void sim6He(Int_t events_count = 10)
void sim6He(Int_t events_count = 1000)
...
// void sim(Int_t events_count = 100000)
{
	...
	targetDecay->Set6HeExcitation(0., 0., 1);
	targetDecay->Set6HeExcitation(0.0031, 0.0006, 1);
	targetDecay->Set6HeExcitation(0.006, 0.002, 2);
	//  targetDecay->Set8HeExcitation(0.009, 0.00412, 1);

	targetDecay->Print6HeExcitation();
